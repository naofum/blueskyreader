...
//		resultStream.write(resultAsString.getBytes(Constants.ENCODING));
	...
	String getNavId() {
		return NAVDocument.NAV_ITEM_ID;
	}
	
	String getNavHref() {
		return NAVDocument.DEFAULT_NAV_HREF;
	}

	String getNavMediaType() {
		return MediatypeService.XHTML.getName();
	}

	String getNcxId() {
		return NCXDocument.NCX_ITEM_ID;
	}
