...
public class EpubReader {
    ...
    public Book readEpub(Resources resources, Book result) throws IOException{
		...
		Resource navResource = resources.findFirstResourceByProperties("nav");
		result.setNavResource(navResource);
		navResource = processNavResource(packageResource, result);
		if (navResource == null) {
	...
	private Resource processNavResource(Resource packageResource, Book book) {
		return NAVDocument.read(book, this);
	}
