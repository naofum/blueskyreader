...
public class Resource implements Serializable {
	...
	public Resource(String id, byte[] data, String href, MediaType mediaType, String inputEncoding) {
		...
		if (this.id != null && this.id.equals(NAVDocument.NAV_ITEM_ID)) {
			this.properties = NAVDocument.NAV_ITEM_ID;
		}
		this.data = data;
	}
	 ...
	 *
	 * @return This resource's properties.
	 */
	...
	/**
	 * This resource's media-overlay.
	 *
	 * @return This resource's properties.
	 */
	public String getMeidaOverlay() {
		return mediaOverlay;
	}
