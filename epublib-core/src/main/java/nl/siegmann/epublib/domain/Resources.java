...
public class Resources implements Serializable {
	...
	/**
	 * Gets the first resource with the given properties.
	 *
	 * Useful for looking up the table of contents as it's supposed to be the only resource with NAV properties.
	 *
	 * @param properties
	 * @return the first resource with the given properties.
	 */
	public Resource findFirstResourceByProperties(String properties) {
		return findFirstResourceByProperties(resources.values(), properties);
	}
	 ...
	 * @return the first resource with the given properties.
	 */
	public static Resource findFirstResourceByProperties(Collection<Resource> resources, String properties) {
		for (Resource resource: resources) {
			if (resource.getProperties().equalsIgnoreCase(properties)) {
				return resource;
			}
		}
		return null;
